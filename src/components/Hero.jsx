...
import profilPic from "../assets/heropic.webp";
...
const Hero = () => {
    return (
        <div id="hero" className="border b border-neutral-900 pb-4 lg:mb-36">
            <div className="flex flex-wrap">
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        ...
                        initial="hidden"
                        animate="visible"
                         className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">Aniket Raj</motion.h2>
                        <motion.span 
